  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            <div className="p-2 rounded-lg bg-green-500/10"><BookOpen className="h-5 w-5 text-green-600" /></div>
            <div><p className="text-2xl font-bold">{uniqueCourses}</p><p className="text-xs text-muted-foreground">{ar ? 'الدورات' : 'Courses'}</p></div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            <div className="p-2 rounded-lg bg-destructive/10"><CalendarDays className="h-5 w-5 text-destructive" /></div>
