...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .brand{margin-top:40px;text-align:center;position:relative;z-index:4;}
    ...
    .photo{position:relative;margin:12px auto 0;width:200px;height:200px;border-radius:50%;
