...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .brand span{font-family:'Archivo Black',sans-serif;font-weight:400;font-size:46px;letter-spacing:-0.5px;text-transform:uppercase;-webkit-text-stroke:1.4px currentColor;}
