  ...
  const handleQualificationPrint = useCallback(() => {
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div style="margin-top:24px;display:flex;justify-content:${ar ? 'flex-start' : 'flex-end'};padding:0 20px;">
          <img src="${stampUrl}" style="max-height:110px;max-width:280px;object-fit:contain;" alt="Stamp" />
        </div>
    ...
    const htmlContent = `
      ...
      <body>
        <table style="direction:${ar ? 'rtl' : 'ltr'};">
          ...
          <tr>
            <td colspan="5" style="text-align:${ar ? 'left' : 'right'};padding:12px 20px;">
              <img src="${stampUrl}" style="height:100px;" alt="Stamp" />
            </td>
          </tr>
