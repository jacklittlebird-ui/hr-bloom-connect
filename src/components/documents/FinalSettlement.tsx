...
.page { width:210mm; height:297mm; margin:0 auto; padding:29mm 31mm 22mm; background:#fff; overflow:hidden; }
.page + .page { page-break-before:always; break-before:page; }
h1 { margin:0 0 20mm; text-align:center; font-size:23px; line-height:1.2; font-weight:500; text-decoration:underline; }
.body-copy { font-size:16px; line-height:2.25; text-align:justify; }
.body-copy p { margin:0 0 3mm; }
.identity { margin-bottom:5mm; }
.conclusion { margin-top:12mm; text-align:center; font-size:17px; font-weight:700; }
.signature-page { padding-top:27mm; }
.signature-block { width:95mm; margin-right:auto; margin-left:0; font-size:17px; line-height:2.6; font-weight:700; text-align:right; }
