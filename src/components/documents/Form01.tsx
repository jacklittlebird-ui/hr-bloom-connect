...
const buildHtml = (e: Emp, logoUrl: string) => `<!DOCTYPE html>
...
<div class="sheet">
  ...
  <div class="sec">
    <div class="grid2">
      <div class="row"><span class="lbl">مقدم الطلب :</span><span class="val">محمود احمد سلامة</span></div>
      <div class="row"><span class="lbl">صفة مقدم الطلب :</span><span class="val">مندوب</span></div>
    </div>
  </div>
  ...
  <div class="sec">
    ...
    <div class="grid2">
      ...
      <div class="row"><span class="lbl">القطــاع :</span><span class="val"></span></div>
      <div class="row"><span class="lbl">كـود الاشــتراك :</span><span class="val"></span></div>
    </div>
    <div class="grid2">
      <div class="row"><span class="lbl">نوع المــدة :</span><span class="val"></span></div>
      <div class="row"><span class="lbl">أجر / دخل الإشتراك :</span><span class="val"></span><span>جنيــه</span></div>
      <div class="row"><span class="lbl">الأجر الشامل :</span><span class="val"></span></div>
    </div>
    <div class="grid2">
  ...
  <div class="sec">
    ...
    <div class="grid2">
      <div class="row"><span class="lbl">عقار رقم :</span><span class="val"></span></div>
      <div class="row"><span class="lbl">شارع :</span><span class="val">${esc(e.address)}</span></div>
      <div class="row"><span class="lbl">قرية :</span><span class="val"></span></div>
    </div>
    <div class="grid2">
  ...
  <div class="row" style="margin-top:14px;"><span class="lbl">تحـريراً في :</span><span class="val" style="max-width:120px"></span>
...
export const Form01 = () => {
  ...
  const html = selected ? buildHtml(selected, nosiLogo.url) : '';
