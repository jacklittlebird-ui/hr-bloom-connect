    ...
    await debouncedFetch(`portal_leaves_${LEAVES_CACHE_VERSION}_${scopedEmployeeId || 'all'}`, async () => {
      ...
      try {
        ...
        if (lbRes.data) {
          ...
          // IMPORTANT: aggregate over the FULL year from *AggRes (unbounded), not the
          // 30-row display lists — otherwise heavy users under/over-count and their
